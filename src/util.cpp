...
const char * const BITCOIN_CONF_FILENAME = "billionaire.conf";
const char * const BITCOIN_PID_FILENAME = "billionaire.pid";
...
#else
    const char* pszModule = "billionaire";
#endif
    if (pex)
        return strprintf(
